			 ...
			 the_content(
				 ...
				 if ( ! empty( $terms ) && ! is_wp_error( $terms ) ) {
					 ...
					 foreach ( $terms as $term ) {
						 $i++;
						 if ( $i == 1 ) { $tab_class = ' active' ; $tab_aria = 'aria-selected="true"'; } else { $tab_class = '' ; $tab_aria = 'aria-selected="false"'; };
