...
if (!function_exists('hounslow_intranet_entry_related_links')) :
	...
	function hounslow_intranet_entry_related_links()
	{
		if (rwmb_meta('lbh_draft_sharepoint')) : ?>
			<aside id="entry-supplementary-content" class="row pb-3 border-bottom">
				<div class="col-lg-12">
...
if (!function_exists('hounslow_intranet_link_thumbnail')) :
	...
	function hounslow_intranet_link_thumbnail($post)
	{
		...
		?>
			<a class="post-thumbnail" href="<?php echo get_the_permalink($post); ?>" aria-hidden="true" tabindex="-1"><img src="<?php echo get_bloginfo('stylesheet_directory'); ?>/assets/img/link-thumbnail-default.jpg" />
